            ...
            <main className="flex-1 max-w-3xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
                ...
                <section className="bg-white rounded-2xl border border-gray-100 p-6 sm:p-8 mb-6">
                    ...
                    <p className="text-sm text-gray-700 leading-relaxed mb-3">
                        Цените и онлајн нарачките се во подготовка и ќе бидат објавени пред активирање на онлајн продажбата.
                    </p>
                    <p className="text-sm text-gray-700 leading-relaxed">
                        Условите за испорака и сите трошоци поврзани со нарачка ќе бидат јасно наведени пред овозможување на онлајн нарачки.
                    </p>
                </section>
