        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="bg-white rounded-2xl border border-gray-100 p-8 md:p-10 space-y-6 text-gray-700 leading-relaxed">
                    ...
                    <p>
                        <strong>Важно:</strong> Интер Стар ДОО - Куманово не сноси одговорност за евентуални доцнења на пратките предизвикани од страна на доставувачката компанија (карго партнерот). По предавањето на пратката на курирската служба, навремената достава е во нивна надлежност. Ние ќе ве известиме по е-пошта кога вашата нарачка е испратена и предадена на карго компанијата.
                    </p>
