...
const faqs = [
    {
        q: "Дали имате LEGO играчки?",
        a: "Да, располагаме со широк асортиман на оригинални LEGO играчки за сите возрасти. Ги нудиме сите популарни теми како LEGO City, LEGO Friends, Ninjago, Technic и многу други."
    },
    {
        q: "Колку чини достава?",
        a: "Доставата се наплаќа по договор, во зависност од големината на пратката и локацијата. Цената за достава ќе ви биде соопштена при телефонската потврда на нарачката пред да биде испратена."
    },
    {
        q: "Дали плаќате при достава?",
        a: "Да! Сите онлајн нарачки за територијата на Македонија се плаќаат исклучиво при достава (готовински при преземање од курирот). Ова ви овозможува 100% сигурно купување."
    },
    {
        q: "Кои брендови продавате?",
        a: "Ние нудиме само најквалитетни, светски признати брендови. Покрај LEGO, ќе најдете и играчки од Barbie, Bruder, Clementoni, Paw Patrol, Kikka Boo, Nip и многу други докажани производители."
    },
    {
        q: "До каде испорачувате?",
        a: "Иако нашата физичка продавница се наоѓа во Куманово, нашиот онлајн магазин врши достава низ целата територија на Македонија. Вашата нарачка ќе пристигне безбедно до вашата врата."
    },
    {
        q: "Дали имате подарок пакување?",
        a: "Апсолутно. Доколку сакате бесплатна услуга за подарок пакување, само напоменете го тоа во забелешка при креирање на онлајн нарачката, или ќе го договориме при телефонската потврда."
    },
    {
        q: "Кога е отворена продавницата?",
        a: "Нашата продавница во Куманово (на ул. Народна Револуција 43) е отворена од понеделник до сабота, секој ден од 09:00 до 21:00 часот. Во недела не работиме."
    },
    {
        q: "Можам ли да нарачам онлајн?",
        a: "Секако! Можете лесно и брзо да нарачате преку нашиот онлајн каталог 24 часа на ден. Не ви е потребен кориснички профил, системот овозможува брза гостинска наплата."
    }
];
