...
export const SHOP_DISABLED_MESSAGE = 'Сајтот е во изработка. Онлајн нарачките се привремено оневозможени. За контакт јавете се на 031 422 656 или пишете на interstarmak@yahoo.com.';
